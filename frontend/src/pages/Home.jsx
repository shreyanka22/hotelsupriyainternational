...
// <h1 className="absolute text-[140px] font-serif text-yellow-500/20 text-center leading-none">
// HOTEL SUPRIYA
// <br/>
// INTERNATIONAL
// </h1>
...
// className="relative w-[720px] drop-shadow-[0_80px_80px_rgba(0,0,0,0.8)]"
// />
...
// Luxury Stay in Sirsi
// </h2>

// <button className="bg-yellow-500 text-black px-10 py-4 rounded-xl hover:scale-105 transition">
// Book Your Stay
// </button>
...
// viewport={{once:true}}
// className="backdrop-blur-lg bg-white/5 border border-yellow-500/20 rounded-[60px] p-20 max-w-6xl grid md:grid-cols-2 gap-12"
// >

// <div>

// <h2 className="text-5xl text-yellow-400 mb-8">
// About Us
// </h2>

// <p className="text-gray-300 leading-relaxed text-lg">
// Hotel Supriya International provides luxurious accommodation,
// fine dining restaurants, banquet halls and modern hospitality.
// Located in the heart of Sirsi, the hotel offers a comfortable
// and elegant stay experience.
// </p>
...
// <motion.div whileHover={{scale:1.05}} className="bg-white/5 rounded-3xl overflow-hidden border border-yellow-500/20">
// <img src="https://hotelsupriyainternational.com/images/room/deluxeroom.jpg"/>
// <h3 className="p-6 text-xl">Deluxe Room</h3>
// </motion.div>

// <motion.div whileHover={{scale:1.05}} className="bg-white/5 rounded-3xl overflow-hidden border border-yellow-500/20">
// <img src="https://hotelsupriyainternational.com/images/room/executiveroom.jpg"/>
// <h3 className="p-6 text-xl">Executive Room</h3>
// </motion.div>

// <motion.div whileHover={{scale:1.05}} className="bg-white/5 rounded-3xl overflow-hidden border border-yellow-500/20">
// <img src="https://hotelsupriyainternational.com/images/room/suiteroom.jpg"/>
// <h3 className="p-6 text-xl">Suite Room</h3>
// </motion.div>
...
// <div className="text-yellow-400">EV Charging</div>
// <div className="text-yellow-400">Restaurant</div>
// <div className="text-yellow-400">Free WiFi</div>
// <div className="text-yellow-400">Parking</div>
...
// <img src="https://hotelsupriyainternational.com/images/tourism/1.jpg" className="rounded-2xl"/>
// <img src="https://hotelsupriyainternational.com/images/tourism/2.jpg" className="rounded-2xl"/>
// <img src="https://hotelsupriyainternational.com/images/tourism/5.jpg" className="rounded-2xl"/>
...
// <img src="https://hotelsupriyainternational.com/images/gallery/1.jpg"/>
// <img src="https://hotelsupriyainternational.com/images/gallery/2.jpg"/>
// <img src="https://hotelsupriyainternational.com/images/gallery/3.jpg"/>
// <img src="https://hotelsupriyainternational.com/images/gallery/4.jpg"/>
...
// <h2 className="text-6xl text-yellow-400 mb-10 text-center">
// Experience Luxury
// <br/>
// at Hotel Supriya
// </h2>

// <button className="bg-yellow-500 text-black px-12 py-5 rounded-xl hover:scale-105 transition text-lg">
// Book Your Stay
// </button>
...
//       <motion.div className="flex gap-8 py-6" style={{ x, width: "200%" }}>
//         {items.map((item, i) => (
//           <TiltCard key={i} className="flex-shrink-0 w-80 rounded-3xl overflow-hidden border border-yellow-500/30 bg-black/40 backdrop-blur-sm">
//             <div
//               className="h-56 bg-cover bg-center"
//               style={{ backgroundImage: `url(${item.img})` }}
//             />
//             <div className="p-6">
//               <div className="text-yellow-400 text-xs tracking-[0.3em] uppercase mb-2">{item.tag}</div>
...
//     >
//       <div className="text-yellow-500 tracking-[0.4em] text-xs uppercase mb-4">{eyebrow}</div>
//       <h2
...
// /* ── Main Component ── */
// export default function HotelSupriya() {
...
//     {
//       name: "Deluxe Room",
//       desc: "Spacious comfort with modern amenities, perfect for the discerning traveler.",
//       price: "₹4,500",
//       tag: "Most Popular",
//       img: "https://hotelsupriyainternational.com/images/room/deluxeroom.jpg",
//       features: ["King Bed", "Mountain View", "Free WiFi", "Mini Bar"],
//     },
//     {
//       name: "Executive Room",
//       desc: "Elevated elegance with premium furnishings and exclusive business amenities.",
//       price: "₹6,500",
//       tag: "Business Favorite",
//       img: "https://hotelsupriyainternational.com/images/room/executiveroom.jpg",
//       features: ["Work Desk", "Lounge Access", "Breakfast", "Premium TV"],
//     },
//     {
//       name: "Suite Room",
//       desc: "The pinnacle of luxury — your private sanctuary in the heart of Sirsi.",
//       price: "₹12,000",
//       tag: "Ultimate Luxury",
//       img: "https://hotelsupriyainternational.com/images/room/suiteroom.jpg",
//       features: ["Living Room", "Jacuzzi", "Butler Service", "City View"],
//     },
//   ];
...
//     { icon: "🅿", label: "Parking", desc: "Complimentary secure parking" },
...
//         .gold-text {
//           background: linear-gradient(135deg, #C9A84C 0%, #F0D080 40%, #C9A84C 60%, #8B6914 100%);
...
//         <div
//           className="text-yellow-400 text-xl tracking-[0.3em] uppercase"
//           style={{ fontFamily: "'Cinzel', serif", fontSize: "0.7rem" }}
//         >
//           Hotel Supriya International
//         </div>
//         <div className="hidden md:flex gap-10 text-gray-400 text-xs tracking-widest uppercase"
//           style={{ fontFamily: "'Cinzel', serif", fontSize: "0.6rem" }}>
//           {["Rooms", "Facilities", "Gallery", "Explore"].map((item) => (
//             <a key={item} href={`#${item.toLowerCase()}`}
//               className="hover:text-yellow-400 transition-colors duration-300">{item}</a>
//           ))}
//         </div>
//         <button className="cta-btn px-6 py-2 rounded-sm hidden md:block">Book Now</button>
//       </nav>
...
//             boxShadow: "0 0 80px rgba(201,168,76,0.05) inset",
//           }}
//           animate={{ rotate: 360 }}
...
//             {/* Ground glow */}
//             <ellipse cx="200" cy="460" rx="180" ry="20" fill="url(#glowGrad)" opacity="0.5"/>

//             {/* Main tower */}
//             <rect x="120" y="100" width="160" height="360" fill="url(#buildingGrad)" opacity="0.15"/>
//             <rect x="120" y="100" width="160" height="360" stroke="url(#buildingGrad)" strokeWidth="1" fill="none" filter="url(#glow)"/>

//             {/* Side wings */}
//             <rect x="60" y="200" width="70" height="260" fill="url(#buildingGrad)" opacity="0.1"/>
//             <rect x="60" y="200" width="70" height="260" stroke="url(#buildingGrad)" strokeWidth="0.5" fill="none"/>
//             <rect x="270" y="200" width="70" height="260" fill="url(#buildingGrad)" opacity="0.1"/>
//             <rect x="270" y="200" width="70" height="260" stroke="url(#buildingGrad)" strokeWidth="0.5" fill="none"/>

//             {/* Spire */}
//             <polygon points="200,20 215,100 185,100" fill="url(#buildingGrad)" opacity="0.9" filter="url(#strongGlow)"/>
//             <line x1="200" y1="20" x2="200" y2="100" stroke="#FFD700" strokeWidth="1.5" filter="url(#strongGlow)"/>
...
//               <line key={`b-${i}`} x1="120" y1={155 + i * 40} x2="280" y2={155 + i * 40}
//                 stroke="#C9A84C" strokeWidth="0.5" opacity="0.4"/>
//             ))}

//             {/* Entrance arch */}
//             <path d="M170 460 L170 420 Q200 400 230 420 L230 460 Z" stroke="url(#buildingGrad)" strokeWidth="1" fill="url(#buildingGrad)" opacity="0.3" filter="url(#glow)"/>

//             {/* Stars around spire */}
//             <circle cx="200" cy="15" r="3" fill="#FFD700" filter="url(#strongGlow)"/>
...
//         >
//           <motion.div
//             className="text-xs tracking-[0.6em] text-yellow-500/70 mb-6 uppercase"
...
//           <motion.h1
//             className="text-[80px] md:text-[120px] leading-none gold-text"
...
//           <motion.div
//             className="text-yellow-500/50 text-xs tracking-[0.8em] mt-4 uppercase"
//             style={{ fontFamily: "'Cinzel', serif" }}
//             initial={{ y: 20, opacity: 0 }}
//             animate={{ y: 0, opacity: 1 }}
...
//           <motion.div
//             className="mt-2 text-gray-400 text-lg font-light tracking-widest"
//             initial={{ y: 20, opacity: 0 }}
//             animate={{ y: 0, opacity: 1 }}
...
//           >
//             <button className="cta-btn px-10 py-4 rounded-sm z-10 relative">
//               Reserve Your Stay
//             </button>
//             <button
//               className="px-10 py-4 rounded-sm border border-yellow-500/30 text-yellow-400/80
//                 hover:border-yellow-400 hover:text-yellow-400 transition-all duration-400 text-xs
...
//             {[["25+", "Years of Legacy"], ["200+", "Luxury Rooms"], ["50K+", "Happy Guests"], ["4.8★", "Avg. Rating"]].map(([num, label]) => (
...
//               Hotel Supriya International is more than a destination — it is an
//               immersive world of refined comfort. From our handcrafted interiors
//               to our curated dining, every detail speaks of our dedication to
//               exceptional hospitality.
//             </p>
//             <p className="text-gray-500 leading-relaxed font-light">
//               Located in the cultural hub of Sirsi, Karnataka, we are your
//               gateway to the Western Ghats' breathtaking wilderness, ancient
//               temples, and vibrant local traditions.
//             </p>
//             <button className="mt-10 cta-btn px-8 py-3 rounded-sm">Discover More</button>
//           </motion.div>
...
//       {/* ── ROOMS ── */}
//       <section id="rooms" className="py-32 px-10 md:px-20 relative">
...
//                 className={`room-tab glass-card px-6 py-3 rounded-full text-sm gold-border transition-all
//                   ${activeRoom === i ? "active text-yellow-400" : "text-gray-500 hover:text-gray-300"}`}
...
//                     <div className="absolute top-4 right-4 bg-yellow-500/20 backdrop-blur-sm
//                       border border-yellow-500/40 rounded-full px-4 py-1 text-yellow-400 text-xs"
//                       style={{ fontFamily: "'Cinzel', serif", fontSize: "0.6rem", letterSpacing: "0.2em" }}>
//                       {rooms[activeRoom].tag}
//                     </div>
//                     <div className="absolute bottom-4 left-4 text-white">
//                       <div className="text-3xl gold-text" style={{ fontFamily: "'Playfair Display', serif" }}>
...
//                   ))}
//                 </div>
//                 <button className="cta-btn px-10 py-4 rounded-sm">Book This Room</button>
//               </div>
//             </motion.div>
//           </AnimatePresence>
//         </div>
...
//       {/* ── FACILITIES ── */}
//       <section id="facilities" className="py-32 px-10 md:px-20 relative overflow-hidden">
...
//           {/* Stats bar */}
//           <motion.div
//             className="mt-20 glass-card rounded-3xl p-10 grid grid-cols-2 md:grid-cols-4 gap-8 text-center shimmer"
//             initial={{ opacity: 0, y: 40 }}
//             whileInView={{ opacity: 1, y: 0 }}
//             viewport={{ once: true }}
//           >
//             {[["200", "+", "Rooms"], ["500", "+", "Events Hosted"], ["25", "+", "Years Legacy"], ["4.8", "★", "Rating"]].map(([n, s, l]) => (
//               <div key={l}>
...
//             {[
//               { img: "https://hotelsupriyainternational.com/images/tourism/1.jpg", title: "Unchalli Falls", dist: "35 km away" },
//               { img: "https://hotelsupriyainternational.com/images/tourism/2.jpg", title: "Sahasralinga", dist: "15 km away" },
//               { img: "https://hotelsupriyainternational.com/images/tourism/5.jpg", title: "Sirsi Marikamba Temple", dist: "City Center" },
//             ].map((place, i) => (
//               <motion.div
//                 key={i}
...
//                 whileHover={{ y: -8 }}
//               >
//                 <img src={place.img} className="w-full h-72 object-cover group-hover:scale-110 transition-transform duration-700" />
...
//       <section className="py-20 px-10 md:px-20">
//         <motion.div
//           className="max-w-4xl mx-auto glass-card rounded-[40px] p-16 text-center relative overflow-hidden"
//           initial={{ opacity: 0 }}
//           whileInView={{ opacity: 1 }}
//           viewport={{ once: true }}
//         >
//           <div className="absolute inset-0 shimmer" />
//           <div className="text-yellow-500/30 text-[120px] leading-none absolute top-4 left-8 select-none"
//             style={{ fontFamily: "'Playfair Display', serif" }}>"</div>
//           <p className="text-2xl md:text-3xl text-gray-200 font-light leading-relaxed relative z-10"
//             style={{ fontFamily: "'Playfair Display', serif", fontStyle: "italic" }}>
//             The service at Hotel Supriya is unmatched. Every detail is thought of —
//             from the pristine rooms to the exceptional cuisine. We return every year.
//           </p>
//           <div className="mt-8 text-yellow-400 text-sm relative z-10">— Priya Sharma, Mumbai</div>
//           <div className="mt-2 text-yellow-500/40 text-xs tracking-widest uppercase relative z-10"
//             style={{ fontFamily: "'Cinzel', serif", fontSize: "0.55rem" }}>Verified Guest</div>
//         </motion.div>
//       </section>
...
//             <button className="cta-btn px-14 py-5 rounded-sm text-sm">Reserve Now</button>
//             <a href="tel:+91" className="px-14 py-5 rounded-sm border border-yellow-500/30 text-yellow-400
//               hover:bg-yellow-500/10 transition-all duration-300 text-xs tracking-widest uppercase text-center"
//               style={{ fontFamily: "'Cinzel', serif", fontSize: "0.65rem" }}>
//               Call Us
//             </a>
//           </div>
...
//           <div>
//             <div className="text-yellow-400 text-sm tracking-[0.4em] uppercase mb-2"
//               style={{ fontFamily: "'Cinzel', serif", fontSize: "0.7rem" }}>
//               Hotel Supriya International
//             </div>
//             <div className="text-gray-600 text-sm">Sirsi, Karnataka, India</div>
//           </div>
//           <div className="flex gap-10 text-gray-600 text-xs tracking-widest uppercase"
//             style={{ fontFamily: "'Cinzel', serif", fontSize: "0.55rem" }}>
//             {["Rooms", "Dining", "Events", "Gallery", "Contact"].map((item) => (
//               <a key={item} href="#" className="hover:text-yellow-400 transition-colors">{item}</a>
//             ))}
//           </div>
//           <div className="text-gray-700 text-xs">
//             © 2024 Hotel Supriya International
//           </div>
//         </div>
//       </footer>
//     </div>
...
//           <TiltCard
//             key={i}
//             className="flex-shrink-0 w-80 rounded-3xl overflow-hidden border border-yellow-500/30 bg-black/40 backdrop-blur-sm"
//           >
...
//     >
//       <div
//         className="text-yellow-500 tracking-[0.4em] text-xs uppercase mb-4"
//         style={{ fontFamily: "'Cinzel', serif" }}
//       >
//         {eyebrow}
//       </div>
...
//       <section
//         ref={heroRef}
//         className="relative h-screen flex items-center justify-center overflow-hidden noise-overlay"
//       >
//         {/* BG glow */}
//         <motion.div
//           className="absolute inset-0"
...
//             {Array.from({ length: 8 }, (_, row) =>
//               Array.from({ length: 5 }, (_, col) => (
//                 <rect key={`w-${row}-${col}`} x={133 + col * 28} y={115 + row * 40} width={16} height={24}
//                   fill="#FFD700" opacity={0.15} filter="url(#glow)"/>
//               ))
//             )}
//             {Array.from({ length: 7 }, (_, i) => (
...
//               className="cta-btn px-10 py-4 rounded-sm z-10 relative"
//             >
//               Reserve Your Stay
//             </button>
//             <button
...
//               className="px-10 py-4 rounded-sm border border-yellow-500/30 text-yellow-400/80
//                 hover:border-yellow-400 hover:text-yellow-400 transition-all duration-300 text-xs
//                 tracking-widest uppercase"
//               style={{ fontFamily: "'Cinzel', serif", fontSize: "0.65rem" }}
//             >
//               Explore Hotel
...
//             <button
//               onClick={() => navigate("/about")}
//               className="mt-10 cta-btn px-8 py-3 rounded-sm"
//             >
//               Discover More
//             </button>
//           </motion.div>
...
//                     <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent" />
//                     <div className="absolute top-4 right-4 bg-yellow-500/20 backdrop-blur-sm border border-yellow-500/40
//                       rounded-full px-4 py-1 text-yellow-400 text-xs"
//                       style={{ fontFamily: "'Cinzel', serif", fontSize: "0.6rem", letterSpacing: "0.2em" }}>
//                       {rooms[activeRoom].tag}
//                     </div>
...
//                 <button
//                   onClick={() => navigate("/accommodations")}
//                   className="cta-btn px-10 py-4 rounded-sm"
//                 >
//                   View All Rooms
//                 </button>
//               </div>
...
//               className="px-10 py-3 rounded-sm border border-yellow-500/30 text-yellow-400/70
//                 hover:border-yellow-400 hover:text-yellow-400 transition-all text-xs tracking-widest uppercase"
//               style={{ fontFamily: "'Cinzel', serif", fontSize: "0.6rem" }}
//             >
//               View All Facilities
//             </button>
...
//             className="cta-btn px-10 py-3 rounded-sm"
//           >
//             View Full Gallery
//           </button>
//         </div>
...
//             <button
//               onClick={() => navigate("/accommodations")}
//               className="cta-btn px-14 py-5 rounded-sm"
//             >
//               Reserve Now
//             </button>
//             <a
//               href="tel:+91"
//               className="px-14 py-5 rounded-sm border border-yellow-500/30 text-yellow-400
//                 hover:bg-yellow-500/10 transition-all duration-300 text-xs tracking-widest uppercase text-center"
//               style={{ fontFamily: "'Cinzel', serif", fontSize: "0.65rem" }}
//             >
//               Call Us
...
//                 className="hover:text-yellow-400 transition-colors">{label}</button>
//             ))}
//           </div>
//           <div className="text-gray-700 text-xs">
//             © 2024 Hotel Supriya International
...
//                 stroke="#C9A84C" strokeWidth="0.5" opacity="0.4"/>
//             ))}
//             <path d="M170 460 L170 420 Q200 400 230 420 L230 460 Z"
//               stroke="url(#bG)" strokeWidth="1" fill="url(#bG)" opacity="0.3" filter="url(#glow)"/>
//             <circle cx="200" cy="15" r="3" fill="#FFD700" filter="url(#sGlow)"/>
//             <circle cx="185" cy="30" r="1.5" fill="#C9A84C" opacity="0.7"/>
//             <circle cx="215" cy="35" r="1.5" fill="#C9A84C" opacity="0.7"/>
//           </svg>
...
//               onClick={() => navigate("/about")}
//               className="px-10 py-4 rounded-sm border border-yellow-500/30 text-yellow-400/80
//                 hover:border-yellow-400 hover:text-yellow-400 transition-all duration-300 text-xs tracking-widest uppercase"
//               style={{ fontFamily: "'Cinzel', serif", fontSize: "0.65rem" }}
//             >
//               Explore Hotel
//             </button>
...
//                 className={`room-tab glass-card px-6 py-3 rounded-full border text-sm transition-all
//                   ${activeRoom === i
//                     ? "active text-yellow-400 border-yellow-500/50"
//                     : "text-gray-500 border-yellow-500/20 hover:text-gray-300"}`}
//                 style={{ fontFamily: "'Cinzel', serif", fontSize: "0.65rem", letterSpacing: "0.15em" }}
//               >
//                 {r.name}
//               </button>
